...
export const PLANS = {
  seed: {
    ...
    features: [
      ...
      { key: 'branches', name: 'Branch Management', included: true },
      ...
      { key: 'member_engagement_vault', name: 'Member Engagement Vault', included: false },
  ...
  growth: {
    ...
    features: [
      ...
      { key: 'member_engagement_vault', name: 'Member Engagement Vault', included: true },
  ...
  sanctuary: {
    ...
    features: [
      ...
      { key: 'branches', name: 'Branch Management', included: true },
      { key: 'all_growth_ascend_features', name: 'All Growth & Ascend Plan Features', included: true },
      ...
      { key: 'attendance_tracking', name: 'Attendance Tracking', included: true },
      { key: 'ai_shepherd_alerts', name: 'AI "Shepherd" Alerts', included: true },
      { key: 'sms_credits', name: 'SMS Credits (Custom)', included: true },
      { key: 'group_dues', name: 'Group Dues Module', included: true },
      { key: 'financial_reporting', name: 'Advanced Financial Reporting', included: true },
      { key: 'event_management', name: 'Event Management', included: true },
      { key: 'vendor_management', name: 'Vendor Management', included: true },
